    ...
    <div class="crop-detail-container animate-fade-in-up">
      @if (crop()) {
        ...
        <div class="detail-grids-wrapper">
          ...
          <div class="glass-section-card rates-container-card">
            <div class="section-card-header">
              ...
              <h3>{{ 'CROPS.DETAIL.MANDI_RATES' | translate }}</h3>
            </div>
            ...
            <div class="mandi-table-wrapper">
              @if (loadingPrices()) {
                <div class="mandi-spinner-box">
                  ...
                  <span>{{ 'CROPS.DETAIL.LOADING_PRICES' | translate }}</span>
                </div>
                ...
                <div class="responsive-table-scroll">
                  <table class="mandi-prices-table">
                    <thead>
                      <tr>
                        <th>{{ 'CROPS.DETAIL.TABLE_MANDI' | translate }}</th>
                        <th>{{ 'CROPS.DETAIL.TABLE_DISTRICT' | translate }}</th>
                        <th>{{ 'CROPS.DETAIL.TABLE_MIN_MAX' | translate }}</th>
                        <th class="text-right">{{ 'CROPS.DETAIL.TABLE_MODAL' | translate }}</th>
                      </tr>
                    </thead>
                    <tbody>
                ...
                <div class="no-data-placeholder">
                  ...
                  <p>{{ 'CROPS.DETAIL.NO_MANDI_DATA' | translate }}</p>
                </div>
              }
            </div>
          </div>
        ...
        <div class="outer-spinner-box">
          ...
          <span>{{ 'CROPS.DETAIL.FETCHING_DETAILS' | translate }}</span>
        </div>
      }
    </div>
  `,
